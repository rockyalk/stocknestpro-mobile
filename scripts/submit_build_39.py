...
def main():
    ...
    print("Step 1: Triggering EAS build 39 for iOS production...")
    ...
    try:
        ...
        log_file = "/home/ubuntu/stocknestpro-mobile/monitor_39.log"
        os.system(f"nohup python3 -u /home/ubuntu/stocknestpro-mobile/scripts/monitor_and_submit_39.py {build_id} > {log_file} 2>&1 &")
